            ...
            <div class="main-content">
                ...
                <div class="p-6">
                    <form action="../../backend/recipe.php" method="post" id="recipeForm" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="current_image" value="../../uploads/recipes/<?php echo $recipe['image_recipe']?>">
...
3. Hidang Makanan" required><?php echo htmlspecialchars($recipe['tutorial_recipe'])?></textarea>
                        ...
                        <div class="flex gap-4 mt-6">
                            <button type="submit" name="create_recipe" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 hover:bg-primary-800">
                                Tambah Resipi
                            </button>
                        </div>
                    </form>
